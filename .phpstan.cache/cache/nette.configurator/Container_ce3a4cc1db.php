...
class Container_ce3a4cc1db extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_ce3a4cc1db $container)
			{
	...
	public function createServiceContainer(): Container_ce3a4cc1db
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'_' => '/Users/brian/Library/Application Support/Herd/bin/php85',
