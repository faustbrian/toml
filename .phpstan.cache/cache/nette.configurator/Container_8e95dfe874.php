...
class Container_8e95dfe874 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_8e95dfe874 $container)
			{
	...
	public function createServiceContainer(): Container_8e95dfe874
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'OLDPWD' => '/Users/brian/Developer/GitHub/suspend',
				'LANG' => 'en_US.UTF-8',
